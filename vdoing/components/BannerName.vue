        ...
        <div class="tabs-panels">
          <ul class="tabs-panel commands">
            ...
            <li class="commands-item">
              ...
              ><span class="commands-item-info" data-demo="#countdown 10"
                >#countdown<span class="commands-item-mode">number</span></span
              ><span class="commands-item-action">Demo</span>
            </li>
            <li class="commands-item">
          ...
          <div class="tabs-panel ui-share">
            <div class="ui-share-content">
              <h1>Sharing</h1>
              <p>
                Simply add <em>?a=</em> to the current URL to share any static
                or animated text. Examples:
              </p>
              <p>
                <a
                  href="http://www.kennethcachia.com/shape-shifter?a=Hello"
                  target="_blank"
                  >www.kennethcachia.com/shape-shifter?a=Hello</a
                ><br />
                <a
...
<script>
// import '@theme/components/banner/js';
export default {
  name: 'BannerName',
};
</script>
...
<style>
@import url('./banner/css/style.css');
</style>
